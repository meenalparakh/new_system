...
def setup_cfg(device):
    ...
    cfg.MODEL.RETINANET.SCORE_THRESH_TEST = 0.235
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.235
    cfg.MODEL.PANOPTIC_FPN.COMBINE.INSTANCES_CONFIDENCE_THRESH = 0.235
