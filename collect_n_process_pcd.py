...
if __name__ == '__main__':
    ...
    if not args.skip_collection:
        dataset.collect_scenes([scene_name], scenes_dir,
    ...
    if not args.skip_process:
        scene.merge_and_clean_pcd(skip_if_done=False, visualize=args.visualize, 
    ...
    if args.data_gen:
        if scene.summary["table_only"]:
            ...
            scene_data_dir = dataset.save_labeled_data_from_pcd(scene,
                  n_close=1, n_far=1, n_random_near=10, n_random_far=10)
