...
from grasping.model.models_pointnet import FPModule, SAModule, MLP
from grasping.test_meshcat_pcd import viz_pcd as V
...
class ContactNet(nn.Module):
    ...
    def get_key_points(self, grasps_list, include_sym=False):
        pts_list = []
        gripper_object = mesh_utils.create_gripper(root_folder=ROOT_FOLDER, configuration='panda')
